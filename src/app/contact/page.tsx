        ...
        <div className=" shadow-lg sm:w-full md:w-[30%] h-[400px] flex flex-col justify-evenly">
          <div className=" pl-3">
            <div className="flex justify-start items-center   ">
              <span className="my-2 bg bg-red-500 p-3 pl-3 rounded-[50%]"></span>
        ...
        <div className=" shadow-lg sm:w-full md:w-[70%] h-[400px]  ">
          ...
          >
            <input
              ...
              className="py-3 px-3 sm:mt-1 md:mt-5 sm:w-full md:w-[200px] bg-[#F5F5F5] rounded-md "
            />{" "}
            <br />
            <input
              type="email"
              placeholder="your Email"
              className="py-3 px-3 sm:w-full md:w-[200px] sm:mt-0 md:mt-5 bg-[#F5F5F5] rounded-md "
            />{" "}
            <br />
            <input
              type="password"
              placeholder="your Phone"
              className="py-3 px-3 sm:mt-0 sm:w-full md:w-[200px] md:mt-5 bg-[#F5F5F5] rounded-md "
            />
          </form>

          <div className="w-full sm:h-[100px] md:h-[150px] lg:h-[200px]  bg-[#F5F5F5] mt-4 rounded-md">
            <input
              type="text"
              placeholder="Your Message"
              className="py-1 rounded-md px-3 mt-5 bg-[#F5F5F5]"
            />{" "}
            <br />
          </div>
          <input
